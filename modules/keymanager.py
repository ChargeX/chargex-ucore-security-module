...
PRIVATE_KEY_DIR = os.environ['SNAP_COMMON'] + '/private-key.pem'
PUBLIC_KEY_PKCS8_DIR = os.environ['SNAP_COMMON'] + '/private-key-pkcs8.pem'
PUBLIC_KEY_DIR = os.environ['SNAP_COMMON'] + '/public-key.pem'
